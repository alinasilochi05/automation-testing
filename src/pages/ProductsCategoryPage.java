...
public class ProductsCategoryPage {
    ...
    By addToCartButton = By.xpath("//*[@id=\"maincontainer\"]/div/div/div/div/div[2]/div[2]/div[2]/div[3]/a");
    By sortByDropdown = By.id("sort");
    By product = By.cssSelector("#maincontainer > div > div > div > div > div.thumbnails.grid.row.list-inline > div:nth-child(2) > div.thumbnail > a");
